	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (centralPara.getStart() == true) {
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				int window = 5;
				TreeMap<Integer,Integer> predictor = AnalyzeABIFdata.predictiveAlgorithm(qualScore, threshold,threshold2, coList, clearanceLevel, doList,peak2ValleyDiff, window );
