	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(centralPara.getNumOpen() > 0){
			...
			if (option == JOptionPane.OK_OPTION) {
				...
				TreeMap<Integer, Integer> predicter = AnalyzeABIFdata.predictiveAlgorithm(qualScore, qualityThreshold.getValue(), qualityThreshold2.getValue(), coList, clearanceSlider.getValue(), doList, differentialSlider.getValue(), windowSlider.getValue()); 
				...
				centralPanel.setWindow(windowSlider.getValue());
			}
