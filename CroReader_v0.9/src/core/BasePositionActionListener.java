...
//Listener to shut off or turn on base number information on chromatogram

public class BasePositionActionListener implements ActionListener {
	...
	public BasePositionActionListener(CentralParameterStorage centralPara, CentralPanelStorage centralPanel,
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(centralPara.getNumOpen() > 0){
			...
			if(basePositionOn == true){
				...
				centralPanel.setBasePositionOn(basePositionOn);

			}

			else if(basePositionOn == false){
				basePositionOn = !basePositionOn;
				DrawRawChannelDataPanel paintPanel = new DrawRawChannelDataPanel(channel1Data.length + 200, verticalSegmentNumber + 200,
						qualScore, qualScoreNuc, channel1Data, channel2Data, channel3Data,
						channel4Data, peakLocation, colors, verticalUnit, verticalSegmentNumber, 100, 100, predict,reversed,basePositionOn,baseCallOn,qualityScoreOn,toggleRegionOn);
