...
// Listener for shutting off quality score information within chromatogram




public class QualityScoreActionListener implements ActionListener {
	...
	public QualityScoreActionListener(CentralParameterStorage centralPara, CentralPanelStorage centralPanel,
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(centralPara.getNumOpen() > 0){
			...
			if(qualityScoreOn == true){
				...
				centralPanel.setQualityScoreOn(qualityScoreOn);

			}

			else if(qualityScoreOn == false){
				qualityScoreOn = !qualityScoreOn;
				DrawRawChannelDataPanel paintPanel = new DrawRawChannelDataPanel(channel1Data.length + 200, verticalSegmentNumber + 200,
						qualScore, qualScoreNuc, channel1Data, channel2Data, channel3Data,
						channel4Data, peakLocation, colors, verticalUnit, verticalSegmentNumber, 100, 100, predict,reversed,basePositionOn,baseCallOn,qualityScoreOn, toggleRegionOn);
